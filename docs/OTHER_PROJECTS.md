...
- **WASM size**: **~234KB gzipped (551KB raw)** for the release binary, built with `-O3`, pthreads, and WASM SIMD enabled
...
| WASM size | ~309KB gzipped (806KB raw) | ~211KB gzipped (521KB raw) standard; ~218KB gzipped (533KB raw) deluxe | ~234KB gzipped (551KB raw) | Large app binary, fixed 512MB heap |
...
| WASM gzipped | ~309KB | ~211KB standard; ~218KB deluxe | ~234KB | N/A |

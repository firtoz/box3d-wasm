...
- **WASM size**: **~256KB gzipped (603KB raw)** for the release binary, built with `-O3`, pthreads, WASM SIMD, and `WASM_BIGINT` enabled
...
| WASM size | ~309KB gzipped (806KB raw) | ~211KB gzipped (521KB raw) standard; ~218KB gzipped (533KB raw) deluxe | ~256KB gzipped (603KB raw) | Large app binary, fixed 512MB heap |
...
| WASM gzipped | ~309KB | ~211KB standard; ~218KB deluxe | ~256KB | N/A |

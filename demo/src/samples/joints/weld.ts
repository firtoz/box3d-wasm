...
import { buildWeldJointDynamicBodies, weldJointCamera, weldJointGroundSize, weldJointVisibleBodies } from "./weld-scene";
...
export const weldJointSample: DemoSample = {
  ...
  create(runtime: Box3DRuntime, scene: THREE.Scene) {
    ...
    const handles = buildWeldJointDynamicBodies(world, runtime);

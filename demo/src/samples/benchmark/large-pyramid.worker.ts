...
import {BodyType, type Vec3, type BodyId} from "box3d-wasm";
...
class LargePyramidWorker extends PhysicsWorkerBase {
  ...
  protected async buildScene(): Promise<BodyId[]> { return buildLargePyramidDynamicBodies(this.world!, this.runtime!); }
